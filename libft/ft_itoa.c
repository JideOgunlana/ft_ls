...
/*   Updated: 2022/04/28 15:14:37 by bogunlan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_convert_number(int digit_c, long long nmb, char *res, int tmp_n)
{
	int	i;
...
char	*result(int n, char *res, int sign, int digit_c)
{
	if (sign >= 0)
	{
		res[0] = n + 48;
